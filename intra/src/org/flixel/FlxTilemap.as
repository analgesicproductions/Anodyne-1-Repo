package org.flixel
{
	...
	public class FlxTilemap extends FlxObject
	{
		...
		/**
		 * Sets a tilemap buffer to null so that the next draw call of this tilemap
		 * reinstantates it - useful for switching areas, resizing some map, without
		 * horrible weird problems.
		 * @param	idx
		 * @return true if the buffer was reset, false if there is no such buffer
		 */
		public function null_buffer(idx:int):Boolean {
